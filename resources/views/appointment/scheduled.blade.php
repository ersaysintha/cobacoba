                        ...
                        <table class="table" id="table-sche">
                            ...
                            @foreach ($appointments as $appointment)
                                <tr>
                                    ...
                                    <td><a class="btn btn-outline-success" href="https://api.whatsapp.com/send?phone={{$appointment->no_wa}}" target="_blank" rel="noopener noreferrer">Kirim Pesan WhatsApp</a>
                                    </td>
                                </tr>
                            @endforeach
